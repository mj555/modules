...
#
## This code implements a recurrent neural network trained to compose music. The model, which uses LSTM layers and draws inspiration from convolutional neural networks, learns to predict which notes will
## be played at each time step of a musical piece. the model is written to recognize patterns of harmony and melody
#
